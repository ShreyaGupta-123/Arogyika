...
var cdsc;
var cdscbuttons=0;
var button1,button2,button3,button4,button5,button=0;
var map;
...
function setup() {
  ...
  hos=createSprite(displayWidth/2-200,displayHeight/3);
  hos.addImage(hosImg);
  hos.scale=0.5;

  qm=createSprite(displayWidth/2-530,displayHeight/3);
  qm.addImage(qmImg);
  qm.scale=0.7;

  virus=createSprite(displayWidth/2+150,displayHeight/3);
  virus.addImage(virusImg);
  virus.scale=0.4;

  yoga=createSprite(displayWidth-150,displayHeight/3);
  ...
  back.position(displayWidth-100,displayHeight-100);
  back.hide();
  ...
  video4=document.getElementById("video4").style.display="none"
  video5=document.getElementById("video5").style.display="none"
  ...
  button4=createButton("Exercises");
  button5=createButton("Nutrients and Nutrition");
  ...
  button4.position(displayWidth/2-500,displayHeight/2);
  button5.position(displayWidth/2-500,displayHeight/2+100);
...
function draw() {
  ...
  if(button===4){
    ...
    video1=document.getElementById("video1").style.display="none"
    video3=document.getElementById("video3").style.display="none"
    video4=document.getElementById("video4").style.display="block"
    video5=document.getElementById("video5").style.display="none"
  ...
  if(button===5){
    ...
    video3=document.getElementById("video3").style.display="none"
    video4=document.getElementById("video4").style.display="none"
    video5=document.getElementById("video5").style.display="block"
