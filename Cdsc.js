class Cdsc{
    ...
    display(){
        ...
        this.info32.html("Diarrhoea can be caused by bacteria(Samonella) or virus(Rotavirus). It is spread through contaminated food or drinking water.");
        ...
        this.info106.html("Try massaging with oils to relief pain. Try light exercises to relief pain. consult a specialist if required.");
